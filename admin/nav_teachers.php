<section class="content" id="main-content">
    <div class="container-fluid">
        ...
        $teachersQuery = "SELECT COUNT(*) as total FROM users WHERE id_role = 3";
        ...
        $teachers = mysqli_fetch_assoc(mysqli_query($conn, $teachersQuery))['total'];
        ?>
        ...
        <div class="row stats-row">
            ...
            <!-- Add Teacher Card -->
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="action-card add-teacher">
                    <div class="card-body">
                        <a href="register_teacher.html" class="action-link">
